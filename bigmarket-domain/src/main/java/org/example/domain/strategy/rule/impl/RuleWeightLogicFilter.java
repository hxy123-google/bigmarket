...
import org.example.domain.strategy.rule.ILogicFilter;
...
public class RuleWeightLogicFilter implements ILogicFilter<RuleActionEntity.RaffleBeforeEntity> {
    ...
    private Map<Long, String> getAnalyticalValue(String ruleValue){
        String[] ruleValueGroups = ruleValue.split(Constants.SPACE);//4000：/5000：
        ...
        for (String ruleValueKey : ruleValueGroups) {
            ...
            // 分割字符串以获取键和值
            String[] parts = ruleValueKey.split(Constants.COLON);//4000 100
            if (parts.length != 2) {
